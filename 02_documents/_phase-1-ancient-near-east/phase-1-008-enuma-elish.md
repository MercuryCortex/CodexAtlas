...
script: "Cuneiform"
region: "Mesopotamia (Babylon and its sphere; later copied throughout Assyrian empire)"
...
refs:
  - title: "Babylonian Creation Myths"
    ...
    year: 2013
    publisher: "Mesopotamian Civilizations 16, Eisenbrauns"
    url: ""
    type: "critical-edition"
    tier: 1
    notes: "Definitive modern critical edition with full transliteration, translation, and commentary"
  - title: "The Babylonian Genesis: The Story of Creation"
    ...
    type: "monograph"
    tier: 1
    notes: "Classic translation and Genesis-comparison; though largely superseded by Lambert (2013) on philology, remains a key reference for the OT-comparison discussion"
  - title: "Before the Muses: An Anthology of Akkadian Literature (3rd ed.)"
    ...
    tier: 1
    notes: "Standard one-volume English anthology; Enuma Elish in vol. 1"
  - title: "Enuma Elish (The Seven Tablets of Creation)"
    ...
    type: "primary-translation"
    tier: 3
    notes: "Older public-domain translation, easily accessible online; superseded scholarly but useful for quick reading"
  - title: "The Priestly Vision of Genesis 1"
    author: "Smith, Mark S."
    year: 2010
    publisher: "Fortress Press"
    type: "monograph"
    tier: 2
    notes: "Argues Genesis 1's relationship to Enuma Elish is structural-typological rather than direct literary dependence"
tags: [phase-1, babylonian, akkadian, creation, chaoskampf, marduk, akitu, library-of-ashurbanipal]
---

# Enuma Elish

## What it is
The Babylonian creation epic, ~1100 lines distributed across seven tablets. The text opens with the Sumero-Akkadian incipit "When on high (enūma eliš) the heavens had not yet been named, nor the earth below mentioned by name," and narrates: (1) primordial Apsu and Tiamat as the original divine principles; (2) successive generations of younger gods, whose noise disturbs Apsu; (3) Apsu's plot to destroy them, his killing by Ea; (4) Tiamat's vengeance: she creates monsters and commissions Kingu to lead her army; (5) Marduk's offer to fight on condition of supremacy; (6) Marduk's combat with Tiamat, her defeat and dismemberment to form the cosmos; (7) the creation of humans from Kingu's blood to serve the gods; (8) the building of Babylon and the Esagila temple; (9) the recitation of Marduk's "fifty names" — a theological catalogue that absorbs other deities' functions into Marduk.

## Primary text — selected excerpts

The following excerpts are reproduced from L. W. King's 1902 public-domain translation (*The Seven Tablets of Creation*, Luzac), available at sacred-texts.com. King's rendering is philologically superseded by Lambert (2013) and Foster (2005) but remains the only freely-distributable English version. Where King is significantly off the mark per Lambert's reconstruction, that is noted.

### Tablet I, lines 1–10 — the incipit (the primordial state)

The opening lines are the literary template later inverted by Genesis 1: existence is defined by what has not yet been *named*, and the only beings are the two undifferentiated cosmic waters, Apsu (sweet/fresh) and Tiamat (salt/sea), commingled.
...
Citation: King, *Enuma Elish* I.1–10 (1902); for the current critical text see Lambert 2013, pp. 50–51.

### Tablet IV — Marduk's combat with Tiamat

The chaoskampf proper. Marduk, having been granted kingship by the divine council in exchange for fighting on its behalf, advances against Tiamat armed with the four winds, a bow, a mace, and a net. The scene's central image — *the body of chaos itself is split to become the cosmos* — is Mesopotamia's most influential cosmogonic contribution.
...
> He drove in the evil wind, that she should not be able to close her lips.
...
Citation: King, *Enuma Elish* IV.93–132 (1902); Lambert 2013, pp. 92–95.

### Tablet VI — the creation of humanity from Kingu's blood

The Mesopotamian anthropology in its starkest form: humans are made to *bear the labor of the gods*. The blood that animates them is the blood of Kingu, Tiamat's slain general — i.e., humanity carries the lifeblood of the defeated chaos-faction. This is the anthropological note that distinguishes the Babylonian theology from Genesis 1's image-of-God.

> Marduk opened his mouth and unto Ea he spake,
...
> They inflicted punishment on him and cut off his blood.
> With his blood they fashioned mankind,
> He [Ea] imposed the service of the gods upon them and set the gods free.

Citation: King, *Enuma Elish* VI.1–8, 31–34 (1902); cf. Lambert 2013, pp. 110–113; Foster 2005, vol. I, pp. 469–470.
...
- [[primordial-waters]] — Apsu (fresh) and Tiamat (salt) as the two undifferentiated cosmic waters; "tehom" in Genesis 1:2 is cognate with Akkadian *tiāmat*.
- [[divine-council]] — the assembly of the Anunnaki/Igigi decides Marduk's elevation; he is granted kingship by acclamation. Same structural motif as Ugaritic Baal's elevation in the [[phase-1-013-baal-cycle]].
- [[divine-kingship]] — Marduk's cosmic kingship grounds the Babylonian king's earthly kingship; the Akitu ritual re-confirms the king's mandate annually.
- **Creation-from-divine-body** — heavens and earth from Tiamat's split body; humans from Kingu's blood. Contrast with [[creation-by-word]] in Memphite Theology and Genesis 1 P.

## Connections (provisional)
- → [[phase-1-006-atrahasis]] — *shared-milieu* / *parallel-motif*: human-creation-to-serve-the-gods is the same anthropology; in Atrahasis humans are created from clay + the blood of slain Wê-ila; in Enuma Elish from Kingu's blood. Atrahasis is structurally older as a coherent narrative; Enuma Elish reframes the anthropology within a Marduk-centered cosmogony.
- → Genesis 1 (Phase 2 work, to be written as [[phase-2-005-hebrew-bible-j-source]] or similar) — *contested-influence*: Gunkel and many subsequent scholars argue Genesis 1's *tehom* and the seven-day structure echo Enuma Elish, with the Hebrew P author *demythologizing* the chaoskampf into creation-by-word. Smith (2010) argues for structural parallel without direct literary dependence — a "shared cosmological grammar" in the Near East. Ref: Smith 2010; Heidel 1951; Day 1985.
- → [[phase-1-013-baal-cycle]] — *parallel-motif* (chaoskampf): Marduk vs. Tiamat and Baal vs. Yam/Mot share the deep structure (storm-warrior god vs. chaotic sea/death). Both ground a young storm-warrior's ascent over an older pantheon. Ref: Day 1985.
- → Hittite Kumarbi cycle and Hesiod's Theogony (Phase 2) — *parallel-motif* (succession myth): the generational displacement of older gods (Apsu → Tiamat → Marduk; Anu → Kumarbi → Teshub; Uranus → Kronos → Zeus) is a Bronze Age Eastern Mediterranean theme. Ref: West 1997, *The East Face of Helicon*.
- → Hebrew Bible chaoskampf residues (Job 26:12, Ps 74:13–14, Isa 27:1, 51:9–10) — *parallel-motif*: where Yahweh defeats Leviathan / Rahab / Yam, the chaoskampf has survived Genesis 1's editing.
...
2. Foster, B.R. (2005). *Before the Muses: An Anthology of Akkadian Literature*, 3rd ed. CDL Press. — accessible English translation.
3. Heidel, A. (1951). *The Babylonian Genesis*. University of Chicago Press, 2nd ed. — classic OT-comparison.
4. King, L.W. (1902). *Enuma Elish*. — older public-domain translation at https://www.sacred-texts.com/ane/enuma.htm
5. Smith, M.S. (2010). *The Priestly Vision of Genesis 1*. Fortress Press. — current state of the Genesis 1 comparison.
6. Day, J. (1985). *God's Conflict with the Dragon and the Sea: Echoes of a Canaanite Myth in the Old Testament*. Cambridge UP. — chaoskampf survivals in the Hebrew Bible.
