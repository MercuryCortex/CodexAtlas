...
date-composed-latest: 75
date-redacted: 75
date-physical-mss-earliest: 250
language: ["Koine Greek (with Latinisms and Aramaic loan-words)"]
script: "Greek uncial"
region: "Roman Syria, Roman Italy, or Galilee — most likely Rome or Syria"
city-of-origin: "Rome (Papias tradition) or Syria-Palestine (modern alternative)"
authorship: "anonymous; traditionally attributed to John Mark, companion of Peter and Paul (Papias, Eusebius); composition by an unnamed early Christian author"
key-figures: ["[[mark-evangelist]]", "[[peter-apostle]]", "[[jesus-of-nazareth]]"]
themes: ["[[messianic-secret]]", "[[son-of-man]]", "[[passion-narrative]]", "[[discipleship-failure]]", "[[apocalyptic-revelation]]"]
parallels: ["[[phase-3-017-gospel-of-matthew]]", "[[phase-3-018-luke-acts]]", "[[phase-3-020-gospel-of-john]]", "[[phase-3-014-q-source]]", "[[phase-4-069-josephus-jewish-war|Josephus *Jewish War*]] (~+75, parallel-portents around the destruction of the Temple — *BJ* 6.288–315 vs. Mark 13's apocalyptic-discourse vocabulary; same milieu within years of one another)"]
influenced-by: ["Hebrew Bible / LXX (esp. Isaiah, Psalms, Daniel)", "Oral Jesus-tradition", "1 Enoch / Daniel apocalyptic", "Pauline kerygma (cross-and-resurrection focus)"]
...
refs:
  - title: "The Gospel of Mark (NIGTC)"
    author: "France, R.T."
    year: 2002
    publisher: "Eerdmans / New International Greek Testament Commentary"
    url: ""
    type: "critical-edition"
    tier: 1
  - title: "Mark: A Commentary (Hermeneia)"
    author: "Marcus, Joel"
    year: 2000
    publisher: "Doubleday / Fortress (2 vols 2000, 2009)"
    type: "critical-edition"
    tier: 1
  - title: "Christology in the Making"
    author: "Dunn, James D.G."
    year: 1980
    publisher: "Westminster / SCM"
    type: "monograph"
    tier: 2
  - title: "How God Became Jesus / How Jesus Became God"
    author: "Bird, Michael F.; Ehrman, Bart D."
    year: 2014
    publisher: "HarperOne / Zondervan"
    type: "monograph"
    tier: 2
    notes: "Two opposed monographs on early high Christology"
  - title: "Bible Gateway — Mark (SBL Greek NT)"
    author: "Bible Gateway"
    year: 2024
    publisher: "Bible Gateway"
    url: "https://www.biblegateway.com/passage/?search=Mark+1&version=SBLGNT"
    type: "primary-translation"
    tier: 1
  - title: "Nestle-Aland 28th ed."
    author: "Aland, K. et al."
    year: 2012
    publisher: "Deutsche Bibelgesellschaft"
    type: "critical-edition"
    tier: 1
tags: [phase-3, early-christianity, synoptic-gospels, mark, markan-priority, passion-narrative, jewish-roman-war]
---
...
- **Who was behind it.** Anonymous. Earliest external attestation: Papias (~+125, preserved in Eusebius), who claims "Mark, having become the interpreter of Peter, wrote down accurately... what was said or done by the Lord." This Papias tradition links the Gospel to Peter's preaching at Rome. Modern scholarship is divided: some accept the Petrine-Roman provenance broadly (Marcus, Hengel), others place composition in Syria-Palestine on internal grounds (Marxsen, Theissen, Kelber).
- **Discovery / transmission.** Continuous canonical transmission. **Markan Priority** — that Mark is the source for Matthew and Luke (and not the other way around) — is the foundational hypothesis of modern Synoptic-problem study, established by Lachmann (1835) and Holtzmann (1863); near-universal consensus since.

## Themes and motifs
- [[messianic-secret]] — Wrede (1901): Mark's Jesus repeatedly silences demons and disciples who identify him as Messiah / Son of God. Whether this is Mark's theological construction (Wrede) or reflects historical reticence by Jesus (Bultmann, Cullmann) is debated.
- [[son-of-man]] — Mark uses *ho huios tou anthrōpou* 14 times, in three modes: present-authority sayings (2:10, 2:28), passion-prediction sayings (8:31, 9:31, 10:33), and apocalyptic-coming sayings (8:38, 13:26, 14:62 — the last quoting Dan 7:13).
- [[passion-narrative]] — chs. 14–15 form what Kähler famously called "a Passion narrative with an extended introduction": fully ~40% of the Gospel concerns the last week and the crucifixion. The Passion narrative is the Gospel's argumentative center.
- [[discipleship-failure]] — Mark portrays the twelve as repeatedly obtuse, fearful, and finally absent (Peter denies, all flee at Gethsemane). This unflattering disciple-portrait is one of Mark's most distinctive features.
- [[apocalyptic-revelation]] — Mark 13 ("the Little Apocalypse"): the destruction of the Temple, cosmic disturbances, the Son of Man on clouds — echoes Daniel 7, 9 and Isaiah 13.

## Connections (provisional)
- → [[phase-3-017-gospel-of-matthew]] — *direct-influence* / *redaction-of*: Matthew incorporates ~90% of Mark's verses, generally with stylistic improvement and theological elaboration.
- → [[phase-3-018-luke-acts]] — *direct-influence* / *redaction-of*: Luke incorporates ~50% of Mark, restructured into a longer two-volume narrative.
- → [[phase-3-014-q-source]] — *shared-milieu*: Mark and Q are two independent early streams; their independent agreements confirm shared early Jesus-tradition.
- → [[phase-3-001-second-third-isaiah]] — *direct-quote*: Mark's opening (1:2–3) cites Isa 40:3 (with Malachi 3:1); the Passion uses Isa 53 imagery; the trial deploys Daniel 7.
- → [[phase-3-008-book-of-daniel]] — *direct-quote*: Mark 13:14 "the desolating sacrilege" cites Dan 9:27/11:31; Mark 14:62 cites Dan 7:13.
- → [[phase-3-015-pauline-epistles]] — *parallel-motif*: shared kerygma of cross-and-resurrection; some scholars (Marcus) read Mark as substantially Pauline in theology; others see independent streams.
- → [[phase-3-020-gospel-of-john]] — *parallel-motif* (independent tradition): John shares the basic Gospel narrative shape with Mark but goes its own way; whether John knew Mark is debated.

## Disputes
- **Date.** Pre-70 (a minority — Hengel, Robinson, Wenham) vs. ~+70/+75 (mainstream, holding 13:14 reflects events of 70). Post-70 is the dominant view.
...
2. France, R.T. (2002). *The Gospel of Mark*. NIGTC.
3. Bird, M.F. & Ehrman, B.D. (2014). *How God Became Jesus* / *How Jesus Became God*.
4. Bauckham, R. (2006). *Jesus and the Eyewitnesses*. Eerdmans.
5. SBL Greek NT / Bible Gateway: https://www.biblegateway.com/passage/?search=Mark+1&version=SBLGNT
