...
language: ["Koine Greek (literary register; high-quality Hellenistic prose)"]
script: "Greek uncial"
region: "Eastern Mediterranean (Syria, Greece, Asia Minor — all proposed)"
city-of-origin: "Antioch (traditional), Achaia (Anti-Marcionite Prologue), Asia Minor (modern alternatives)"
authorship: "anonymous; traditionally attributed to Luke the physician, companion of Paul (Col 4:14; Phlm 24; 2 Tim 4:11); modern scholarship is divided on the traditional attribution"
key-figures: ["[[luke-evangelist]]", "[[paul-of-tarsus]]", "[[peter-apostle]]", "[[jesus-of-nazareth]]"]
themes: ["[[salvation-history]]", "[[gentile-mission]]", "[[holy-spirit-empowered-witness]]", "[[poor-and-marginalized]]", "[[apologetic-historiography]]"]
parallels: ["[[phase-3-016-gospel-of-mark]]", "[[phase-3-017-gospel-of-matthew]]", "[[phase-3-014-q-source]]", "[[phase-3-015-pauline-epistles]]"]
influenced-by: ["Gospel of Mark", "Q", "L source (Lukan special material)", "LXX (Lukan style imitates LXX Greek)", "Hellenistic historiography (Polybius, Josephus's analogous works)"]
...
refs:
  - title: "The Gospel According to Luke (Anchor Yale Bible 28, 28A)"
    ...
    year: 1981
    publisher: "Doubleday (2 vols.)"
    url: ""
    type: "critical-edition"
    tier: 1
  - title: "The Acts of the Apostles (Hermeneia)"
    author: "Pervo, Richard I."
    year: 2009
    publisher: "Fortress Press"
    type: "critical-edition"
    tier: 1
    notes: "Argues for ~+115 date; treats Acts as theological historiography"
  - title: "The Acts of the Apostles (Anchor Yale Bible 31)"
    author: "Fitzmyer, Joseph A."
    year: 1998
    publisher: "Doubleday"
    type: "critical-edition"
  ...
  - title: "The Theology of St Luke"
    ...
    year: 1960
    publisher: "Harper & Row (Eng. trans. of *Die Mitte der Zeit*, 1953)"
    type: "monograph"
    tier: 1
    notes: "Foundational analysis of Lukan salvation-history schema"
  - title: "Luke the Historian in Recent Study"
    author: "Marshall, I. Howard"
    year: 1970
    publisher: "Paternoster"
    type: "monograph"
    tier: 2
  - title: "Bible Gateway — Luke / Acts (SBLGNT)"
    author: "Bible Gateway"
    year: 2024
    publisher: "Bible Gateway"
    url: "https://www.biblegateway.com/passage/?search=Luke+1&version=SBLGNT"
    type: "primary-translation"
    tier: 1
tags: [phase-3, early-christianity, synoptic-gospels, luke, acts, lukan, gentile-mission, paul]
---
...
- **Who was behind it.** Anonymous. Traditional authorship ascribes both volumes to **Luke**, Paul's physician-companion (Col 4:14; Phlm 24). The "we-passages" of Acts (16:10–17; 20:5–15; 21:1–18; 27:1–28:16) are sometimes taken as evidence of personal participation; alternatively as a stylistic device of Hellenistic sea-narrative. Tradition is supported by Hengel, Marshall, Bauckham; modern criticism is divided (Vielhauer, Pervo, Ehrman: not by Paul's companion; Fitzmyer: a sympathetic ancient tradition).
- **Discovery / transmission.** Canonical from early. Marcion's mid-2nd-c. canon adopted a redacted Luke as his only Gospel; the orthodox response solidified canonical Luke. The longer "Western Text" of Acts (Codex Bezae) suggests early textual fluidity in this work.

## Themes and motifs
- [[salvation-history]] — Conzelmann's classic analysis: Luke schematizes time into **three epochs** — Israel (up to John the Baptist), Jesus (the *Mitte der Zeit*, the "middle of time"), and the church (from Pentecost on). Luke's two-volume structure embodies this periodization.
- [[gentile-mission]] — Acts traces the geographical and ethnic expansion *from Jerusalem* outward (1:8 programmatic statement: "Jerusalem, Judea, Samaria, the ends of the earth"). The Cornelius episode (Acts 10–11), the Jerusalem Council (Acts 15), and Paul's Aegean and European missions enact this.
- [[holy-spirit-empowered-witness]] — Pentecost (Acts 2), the Spirit-experiences at Samaria (8), Caesarea (10), Ephesus (19) — Acts is sometimes called "the Gospel of the Holy Spirit." Spirit is the historical and theological engine.
- [[poor-and-marginalized]] — distinctive Lukan emphasis: the Magnificat (Lk 1:46–55), the Beatitudes "blessed are you who are poor" (Lk 6:20, *unmodified* by "in spirit"), the Lazarus parable (16), Zacchaeus (19), and the woes against the rich.
- [[apologetic-historiography]] — Luke writes in conscious imitation of Hellenistic historiographical conventions (Polybius, Thucydides; the prefaces Lk 1:1–4 and Acts 1:1 follow ancient historical-treatise form).

## Connections (provisional)
- → [[phase-3-016-gospel-of-mark]] — *redaction-of*: Luke uses Mark.
- → [[phase-3-014-q-source]] — *redaction-of*: Luke uses Q, generally with greater preservation of original order than Matthew (Kloppenborg).
- → [[phase-3-017-gospel-of-matthew]] — *parallel-motif*: independent uses of Mark + Q (per Two-Source Hypothesis) or direct use of Matthew (per Farrer-Goodacre); Synoptic Problem central.
- → [[phase-3-015-pauline-epistles]] — *parallel-motif* / *commentary-on*: Acts is the primary narrative-source for Paul's career, but with notable discrepancies from the letters (Acts's Jerusalem Council in ch. 15 vs. Paul's account in Gal 1–2 has been a perennial puzzle).
- → [[phase-3-006-septuagint]] — *direct-quote*: Lukan Greek imitates LXX Greek; OT quotations from LXX.
- → [[phase-3-001-second-third-isaiah]] — *direct-quote*: Luke 4:16–21 has Jesus read Isa 61:1–2 in the Nazareth synagogue as programmatic for his mission.
- → Hellenistic historiography (Polybius; later Josephus) — *parallel-motif*: shared genre conventions.

## Disputes
- **Date.** Mainstream: ~+80/+95. Pervo and Tyson place Acts ~+115/+125 (after Josephus's *Antiquities*, ~+93). Conservative scholars: pre-70 (Robinson). The Pervo dating affects whether Luke knew Josephus and Marcion.
...
2. Pervo, R.I. (2009). *Acts* Hermeneia. — major modern critical edition.
3. Conzelmann, H. (1960). *The Theology of St Luke*. — foundational salvation-history reading.
4. Marshall, I.H. (1970). *Luke the Historian in Recent Study*. Paternoster.
5. SBLGNT: https://www.biblegateway.com/passage/?search=Luke+1&version=SBLGNT
