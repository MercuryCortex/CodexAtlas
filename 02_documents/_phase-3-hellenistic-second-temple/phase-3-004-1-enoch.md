...
language: ["Aramaic (original, fragments)", "Greek (translation, partial)", "Ge'ez / classical Ethiopic (complete)"]
script: "Aramaic square; later Greek uncial; later Ge'ez"
region: "Judea, Galilee, possibly diaspora Egypt"
city-of-origin: "Judea"
authorship: "anonymous; pseudepigraphically attributed to the antediluvian patriarch Enoch (Gen 5:18–24)"
key-figures: ["[[enoch]]"]
themes: ["[[watchers-and-fallen-angels]]", "[[apocalyptic-revelation]]", "[[final-judgment]]", "[[heavenly-tour]]", "[[origin-of-evil]]"]
parallels: ["[[phase-3-009-jubilees]]", "[[phase-3-011-dead-sea-scrolls]]", "[[phase-3-008-book-of-daniel]]", "[[phase-3-016-gospel-of-mark]]"]
influenced-by: ["Genesis 6:1–4 (the bĕnê hāʾĕlōhîm episode)", "Babylonian apkallu (sage-from-heaven) traditions", "Persian apocalyptic schemata (Mary Boyce, John J. Collins)"]
...
hub-edges:
  - target: "merkabah-miraj-ascent-chain"
    type: "founding-text-of-heavenly-tour-tradition"
    source: "Nickelsburg 2001 *1 Enoch* (Hermeneia); Nickelsburg & VanderKam 2012 *1 Enoch 2*; Scholem 1941 *Major Trends in Jewish Mysticism*; Schäfer 2009 — 1 Enoch (composed in stages ~300 BCE - 50 BCE) is the founding text of the heavenly-tour tradition in Jewish apocalyptic. The Book of the Watchers (1 Enoch 1-36) narrates Enoch's celestial tour; the Book of Parables (37-71) culminates in the Son of Man vision; the later *3 Enoch / Sefer Hekhalot* (Hekhalot-period) builds on this foundation. Direct upstream of all subsequent ascent-tradition development: Merkabah → Hekhalot → Mi'raj → Dante. See [[merkabah-miraj-ascent-chain]]"
    notes: "MASSIVE-WIN: 1 Enoch is the second-temple-Jewish hinge document of the entire ascent-tradition — without it, no Merkabah elaboration, no Hekhalot mystical practice, no Metatron transformation. Cross-lens: 02_documents → 06_themes"
  - target: "persian-period-injection"
    type: "documentation-of-injection-channels"
    source: "Collins 1998 *The Apocalyptic Imagination*; Boyce 1982 vol. II; Boccaccini 1998 *Beyond the Essene Hypothesis* — 1 Enoch documents the operation of multiple Persian-period injection channels: the seven-archangel scheme (1 En 20) reflecting Amesha Spenta architecture (Channel 4); the Watchers narrative (1 En 6-11) instantiating the cosmic-adversary expansion (Channel 2); 1 En 22 + 4 Ezra 7-style eschatological judgment (Channel 5); the Son of Man pre-existent vindicator (1 En 37-71) anticipating messianic-future-savior structure (Channel 3). See [[persian-period-injection]]"
    notes: "Cross-lens: 02_documents → 06_themes. 1 Enoch is the densest single document demonstrating the *multi-channel concurrent operation* of the Persian-period exchange"
  - target: "theme-rebel-against-the-divine"
    type: "founding-text-of-Enochic-rebel-tradition"
...
refs:
  - title: "1 Enoch: A New Translation"
    ...
    tier: 1
    notes: "Based on Nickelsburg's Hermeneia commentary; current standard English"
  ...
  - title: "1 Enoch 2: A Commentary on the Book of 1 Enoch Chapters 37–82"
    ...
    type: "critical-edition"
    tier: 1
  - title: "The Aramaic Books of Enoch"
    author: "Milik, J.T."
    year: 1976
    publisher: "Clarendon Press, Oxford"
    type: "critical-edition"
    tier: 1
    notes: "Editio princeps of the Qumran Aramaic Enoch fragments"
  - title: "The Apocalyptic Imagination: An Introduction to Jewish Apocalyptic Literature"
    ...
    type: "monograph"
    tier: 1
  - title: "1 Enoch — Sacred Texts Archive (R.H. Charles trans.)"
    author: "Charles, R.H."
    year: 1917
...
## What it is
A composite of at least five originally separate Aramaic compositions, redacted and translated into Greek and finally into Ge'ez:
1. **Book of the Watchers** (chs. 1–36; ~-300 BCE) — expansion of Gen 6:1–4: two hundred angelic Watchers led by Semyaza and Azazel descend on Mount Hermon, take human wives, beget the Giants, teach forbidden arts (metallurgy, cosmetics, sorcery, astrology), and corrupt the earth. God dispatches the archangels (Michael, Gabriel, Uriel, Raphael) to bind them. Enoch is taken up and shown heaven and Sheol.
2. **Book of Parables / Similitudes** (chs. 37–71; ~-50/+50) — three "parables" featuring the "Son of Man / Chosen One" enthroned beside the Head of Days. Not found at Qumran.
3. **Astronomical Book / Book of the Luminaries** (chs. 72–82; ~-300) — solar 364-day calendar polemic; very old.
...
- **Who was behind it.** Anonymous scribal-priestly circles. Strong overlap with the Qumran community: 11 Aramaic copies were found there, more than copies of any other non-canonical work. Some scholars (Boccaccini) speak of an "Enochic Judaism" as a distinct stream.
- **Discovery / transmission.** The Ethiopian Orthodox Church preserves 1 Enoch as scripture (uniquely among Christian bodies) — they likely received it from Egyptian Christian missionaries (Frumentius, 4th c.). It was unknown in Europe until James Bruce returned from Ethiopia in 1773. The Aramaic original was recovered only from Qumran (Cave 4) in the 1950s.

## Themes and motifs
- [[watchers-and-fallen-angels]] — the elaborate fall-of-angels narrative; the source of all later Christian and Islamic demonology and the "fallen-angel-as-Satan" complex.
- [[origin-of-evil]] — evil enters the world through the Watchers' transgression, not (or not only) Adam's. This is a competing explanation to Genesis 3 and remains a Jewish alternative until rabbinic Judaism backgrounds it.
- [[apocalyptic-revelation]] — knowledge from heaven via visions, angelic mediators, and otherworld tours.
- [[heavenly-tour]] — Enoch journeys through the seven heavens, sees the storehouses of winds, judgment chambers, the tree of life.
- [[final-judgment]] — explicit eschatological judgment of humans *and* angels; resurrection language.

## Connections (provisional)
- → [[phase-3-009-jubilees]] — *direct-quote*: Jubilees 4:17–24 explicitly cites Enoch's heavenly writings and incorporates Watchers material.
- → [[phase-3-011-dead-sea-scrolls]] — *shared-milieu* / *manuscript-transmission*: 4Q201–212 are the only Aramaic Enoch fragments extant; Qumran's community lived with Enoch as functional scripture.
- → [[phase-3-008-book-of-daniel]] — *parallel-motif*: Daniel 7's "one like a son of man" coming on the clouds is conceptually linked to 1 Enoch 46's "Son of Man" enthroned beside the Ancient of Days; both are second-century apocalyptic responses to imperial oppression.
- → [[phase-3-016-gospel-of-mark]] / [[phase-3-020-gospel-of-john]] — *parallel-motif* + (*direct-quote* in Jude): the NT "Son of Man" Christology has 1 Enoch 37–71 in its background. Jude 14–15 quotes 1 Enoch 1:9 by name.
- → Christian demonology — *direct-influence*: the names Azazel, Semyaza, and the fall-of-angels framework feed into Tertullian, Origen, Augustine, and ultimately *Paradise Lost*.
- → Manichaean Book of Giants (Phase 4) — *direct-influence*: Mani composed a *Book of Giants* directly modeled on the Aramaic Enochic *Book of Giants* fragments preserved at Qumran.
...
2. Nickelsburg, G.W.E. (2001) and Nickelsburg-VanderKam (2012). *1 Enoch* Hermeneia commentary (2 vols). — definitive critical edition.
