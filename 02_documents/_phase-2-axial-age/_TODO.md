...
- [ ] `phase-2-023-mengzi` — status: metadata (5 refs)
...
- [ ] `phase-2-009-hesiod-theogony-works-and-days` — status: metadata (6 refs)
- [ ] `phase-2-017-mahabharata-ramayana-oral-layers` — status: metadata (6 refs)
- [ ] `phase-2-001-rig-veda-family-books` — status: metadata (5 refs)
- [ ] `phase-2-010-hebrew-bible-early-prophets` — status: metadata (5 refs)
- [ ] `phase-2-005-hebrew-bible-j-source` — status: metadata (6 refs)
- [ ] `phase-2-018-hebrew-bible-p-source` — status: metadata (7 refs)
- [ ] `phase-2-028-herodotus-histories-book-2` — status: metadata (6 refs)
- [ ] `phase-2-024-xunzi` — status: metadata (6 refs)
- [ ] `phase-2-011-hebrew-bible-d-source` — status: metadata (6 refs)
...
## Top unstubbed wikilink targets from this phase (2)

(stub these to close out internal references)

- [ ] `brahman` — referenced 1×
- [ ] `brahma-vedic` — referenced 1×