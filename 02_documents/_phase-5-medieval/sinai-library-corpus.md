...
title: "Sinai Library Corpus"
name: "Sinai Library Corpus"
aka: ["the library of St Catherine's Monastery", "Sinaiticus manuscript collection", "the Mount Sinai manuscripts"]
tradition: "Eastern Orthodox Christian"
canonical-corpus: ["syriac-christian-corpus"]
sub-tradition: "Monastic manuscript library (multilingual Christian East)"
label: "manuscript-corpus"
date-composed-earliest: 400
date-composed-latest: 1500
date-redacted: 1500
date-physical-mss-earliest: 350
language: ["Greek", "Syriac", "Arabic", "Georgian", "Christian Palestinian Aramaic", "Slavonic, Coptic, Armenian, Ethiopic, Latin"]
script: "Greek, Syriac, Arabic, Georgian, and others"
...
deities-mentioned: []
influences: ["New Testament textual criticism (the Codex Sinaiticus); the recovery of lost texts via the Sinai palimpsests; the study of Christian Arabic, Georgian, and Syriac"]
tags: [phase-5, christian, sinai, st-catherine, manuscripts, sinaiticus, palimpsest, multilingual]
---
...
## Refs
1. Kamil, Murad (1970). *Catalogue of All Manuscripts in the Monastery of St. Catharine on Mount Sinai*. Otto Harrassowitz, Wiesbaden. — the standard catalogue of the collection.
2. Parker, D.C. (2010). *Codex Sinaiticus: The Story of the World's Oldest Bible*. British Library / Hendrickson. — on the most famous of the Sinai manuscripts and the collection's significance.
