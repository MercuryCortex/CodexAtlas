...
geo-lat: 35.69
geo-lon: 51.39
geo-label: "Iran (place of compilation)"
historicity: "documented"
key-figures: ["Zarathustra / Zoroaster (attested as prophet throughout)", "Adurfarnbag-i Farroxzadan (9th-c. compiler)"]
deities-mentioned: ["[[ahura-mazda]]", "[[angra-mainyu-ahriman]]", "[[anahita]]", "[[mithra-zoroastrian]]"]
influenced-by:
  - "[[phase-2-002-gathas-of-zarathustra]] — Gathas as primary theological authority"
  - "[[phase-2-004-yasna-younger-avesta]] — Younger Avestan ritual and cosmological framework"
  - "Sasanian court theology and priestly scholarship (destroyed by Arab conquest)"
influences:
...
refs:
  ...
  - title: "Denkart (Dēnkard), Books 3 and 7"
    ...
    tier: 1
  - title: "The Wisdom of the Sasanian Sages (Denkard VI)"
    author: "Shaked, Shaul (tr.)"
    year: 1979
    publisher: "Westview Press"
    type: "primary-translation"
    tier: 1
tags: [document, zoroastrian, pahlavi, middle-persian, theology, encyclopedia, sasanian, medieval]
---
...
### Cosmological transmission: Denkard → Bundahishn chain
The Denkard and [[phase-4-107-bundahishn|Bundahishn]] draw on the same lost Avestan *Zand* (commentary) tradition. Together they represent the two primary surviving vehicles of Sasanian Zoroastrian cosmological thought — the Denkard more theological/encyclopedic, the Bundahishn more cosmogonic/geographical. The cross-tradition edges to Manichaean cosmology, Mandaean dualism, and early Islamic angelology all pass through this corpus.
