...
id: "quetzalcoatl"
name: "Quetzalcoatl"
aka: ["Quetzalcóatl", "Feathered Serpent", "Plumed Serpent", "Ehécatl-Quetzalcóatl (wind aspect)", "Topiltzin Quetzalcoatl (historical-mythic Toltec)"]
tradition: "Nahua / Aztec (Mexica) — and broader Mesoamerican"
region: "Central Mexico (Aztec, Toltec, Teotihuacan); broader Mesoamerica"
period-active-earliest: -200
period-active-latest: 1521
domains: ["wind", "creation", "wisdom", "priesthood", "the morning star (Venus)", "civilization", "agriculture (maize)"]
gender: "masculine"
role: "creator-civilizer god / wind-god / culture-hero"
parent-of: []
child-of: ["Ometecuhtli / Omecihuatl (the primordial dual-god in some traditions)"]
consort: []
attributes: ["feathered serpent", "wind-jewel pectoral (ehécacozcatl)", "duck-billed wind mask (Ehécatl aspect)", "conch-shell ornaments", "Venus"]
attested-in: ["[[phase-8-001-popol-vuh]] (as Q'uq'umatz cognate)", "[[phase-8-002-codex-borgia]]", "[[phase-8-004-florentine-codex-sahagun]]"]
equivalents: ["[[kukulkan]] (Maya)"]
syncretic-edges:
  - target: "[[kukulkan]]"
...
refs:
  - title: "Quetzalcoatl and the Irony of Empire"
    ...
    year: 1982
    tier: 1
  - title: "Quetzalcoatl and Guadalupe"
    author: "Lafaye, Jacques"
    year: 1976
    tier: 1
tags: [mesoamerican, nahua, aztec, mexica, creator, wind, feathered-serpent, phase-8]
---

# Quetzalcoatl

## Identity
The Feathered Serpent — one of the principal deities of central-Mexican Mesoamerican religion across the Postclassic period, with antecedents in Teotihuacan (where the Temple of the Feathered Serpent, ~150 CE, is the oldest major Feathered Serpent monument) and continuity into Aztec Mexica state religion. Quetzalcoatl is creator-civilizer (he is the god who recovered the bones from Mictlan to remake humanity after the previous suns; he taught humans maize-cultivation, calendar, writing, ritual), wind-god (his Ehécatl aspect, with characteristic duck-billed mask, governs wind and breath), and Venus-morning-star (his apotheosis after death). His historical-mythic figure *Topiltzin Quetzalcoatl* — a Toltec priest-king of Tula (~10th c. CE) — is sometimes deified as Quetzalcoatl and sometimes treated as a separate historical figure conflated with the god (see also [[quetzalcoatl-historical]]).

## Earliest attestation
Teotihuacan Temple of the Feathered Serpent (~150 CE) — the earliest major iconographic attestation. Subsequent attestation: Xochicalco (~7th c.), Tula (Toltec, 9th–11th c.), Chichén Itzá (as Kukulkán, 9th–13th c.), Aztec Templo Mayor (~14th–15th c.), Cholula's massive pyramid-temple of Quetzalcoatl (the largest pyramid in the world by volume).

## Mythological role
In *Codex Chimalpopoca / Annales de Cuauhtitlan*, Quetzalcoatl descends to Mictlan, the underworld, and tricks Mictlantecuhtli into giving him the bones of past humanities; he carries them back, spills them, and they are remade with his own blood — creating present humanity. He gives maize. He establishes priestly ritual. Eventually, deceived by Tezcatlipoca (his cosmic rival in Aztec theology), he commits ritual transgression (drunkenness, incest), abandons Tula in shame, and sails east on a raft of serpents — promising to return.

## Cross-tradition identifications
- **[[kukulkan]]** — *ancient-identification*: Yucatec Maya Kukulkán is the Feathered Serpent; the identification is internal to Mesoamerican religion (visible at Chichén Itzá's Toltec-Maya synthesis ~9th–10th c.) and goes both directions — Quetzalcoatl-cult moved south into Maya territory; Maya Kukulkán moved north into central Mexico.
- **Christ (colonial Mexican syncretism)** — *folk-syncretism*: Spanish missionaries and Indigenous-Christian writers (Diego Durán; Mexica converts) identified Quetzalcoatl with Christ or with St. Thomas — same beard, same eastward-departure-and-return promise, same teaching of civilization. Lafaye 1976 is the standard study. The identification served colonial purposes (proving Christianity always present in Mexico) but was theologically genuine for some colonial Mexican Christians.
- **Topiltzin Quetzalcoatl** (historical Toltec ruler) — *euhemerist-conflation*: the historical-mythic 10th-c. Toltec priest-king and the god are conflated in the tradition; how much of the "god's biography" is historical Topiltzin and how much is purely cosmic is disputed (Florescano 1993).

## Iconography
Feathered serpent — the central image. Wind aspect (Ehécatl-Quetzalcóatl): duck-billed mask, distinctive round temple architecture (Ehécatl temples are round, the only round structures in Aztec sacred architecture). The wind-jewel pectoral (*ehécacozcatl*, a cross-section of a marine conch). Black-painted face. Pointed cap.
...
| Mesopotamian (Sumerian/Akkadian) | [[inanna]] / [[ishtar]] | Descent to the Underworld = Venus's inferior conjunction; ascent = heliacal rising as Morning Star | [[phase-1-017-descent-of-inanna]] |
