...
id: "kumarbi"
name: "Kumarbi"
aka: ["Kumarbe", "Kumarpi", "'Father of the Gods' (Hurrian epithet)"]
tradition: "Hurrian–Hittite"
region: "Upper Mesopotamia, Anatolia, North Syria"
period-active-earliest: -1800
period-active-latest: -1180
domains: ["fatherhood of the gods", "grain (one of his Hurrian aspects)", "displaced kingship", "underworld plotting"]
gender: "masculine"
role: "deposed father-god; second-generation sovereign in the Hurrian succession myth"
parent-of: ["[[teshub]]", "Tašmišu", "Tigris (river-god)", "the monster Ullikummi", "the sea-dragon Hedammu"]
child-of: ["Anu (Hurrian — the older sky-god whose genitals Kumarbi bites off and swallows)"]
consort: []
attributes: ["grain ear (Hurrian fertility / grain association)", "council-mace"]
attested-in: ["[[phase-1-028-kumarbi-cycle]]", "Boğazköy archive (Hattusa) — CTH 344 (Song of Going Forth / Song of Kumarbi), CTH 345 (Song of Ullikummi), CTH 348 (Song of Hedammu)", "Ugaritic god-list parallel (Hurrian onomastica)"]
equivalents: ["[[kronos]]", "[[saturn-roman]]", "[[enlil]]", "[[dagon]]"]
syncretic-edges:
  - target: "kronos"
...
refs:
  - title: "Hittite Myths (2nd ed.)"
    ...
    tier: 1
    notes: "Standard English translation of the entire Kumarbi cycle."
  - title: "From Hittite to Homer"
    ...
    type: "monograph"
    tier: 1
    notes: "Argues for direct textual / oral-poetic transmission of the Kumarbi succession myth to the Hesiodic Theogony via Late Bronze Age Aegean-Anatolian singer networks."
  - title: "The East Face of Helicon: West Asiatic Elements in Greek Poetry and Myth"
    ...
    type: "monograph"
    tier: 1
    notes: "Detailed demonstration of the Kumarbi-cycle / Hesiodic Theogony parallels; argues for literary dependence."
  - title: "The Orientalizing Revolution: Near Eastern Influence on Greek Culture in the Early Archaic Age"
    ...
    type: "monograph"
    tier: 1
    notes: "Argues for cultural transmission via Phoenician intermediaries in the 8th–7th c. BCE, an alternative mechanism to West's direct Bronze Age transmission."
  - title: "Kumarbi-Mythen: Untersuchungen zu Komposition und Textaufbau"
    author: "Polvani, Anna Maria; Corti, Carlo (and predecessors Güterbock, Otten)"
    year: "various"
    publisher: "various"
    type: "monograph"
    tier: 1
tags: [deity, hittite, hurrian, succession-myth, father-god, anatolian, substrate-of-kronos]
---

# Kumarbi

## Identity
Kumarbi is the Hurrian "father of the gods" — a deposed, second-generation sovereign whose displacement from cosmic kingship by his son Teshub is the central narrative of the Hurrian succession myth. Kumarbi's role is the *middle* generation between the primordial Anu (sky) and the storm-warrior king Teshub. He has Hurrian grain associations (he is sometimes identified with grain itself in lists) and is identified across the ancient Near East with whichever deity occupies the "deposed father" slot: Sumero-Akkadian Enlil, Ugaritic-Syrian Dagan, and — via post-Bronze Age transmission — Greek Kronos and Roman Saturn.

