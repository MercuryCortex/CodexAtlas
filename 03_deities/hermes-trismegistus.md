...
aka: ["Hermes Trismegistos", "Mercurius Ter Maximus", "thrice-greatest Hermes"]
tradition: "Greco-Egyptian Hermetic syncretism"
region: "Egypt (especially Alexandria); spread across Mediterranean and into Renaissance Europe"
period-active-earliest: -200
period-active-latest: 1700
domains: ["wisdom", "writing", "magic", "astrology", "alchemy", "soul-ascent", "revelation"]
gender: "masculine"
role: "syncretic revelator-god; primal sage-teacher; alleged author of the Hermetic corpus"
parent-of: []
child-of: []
consort: []
...
syncretic-edges:
  - target: "thoth"
    ...
    source: "Continuous Egyptian-Greek identification; Hermopolis (Khmun) had been Thoth's cult center, Hellenized as 'city of Hermes'"
    source-tier: T1
  - target: "hermes-greek"
    type: "ancient-identification"
    source: "Direct Greek identification from Herodotus onward (*Histories* 2.138)"
    source-tier: T1
...
refs:
  - title: "The Egyptian Hermes: A Historical Approach to the Late Pagan Mind"
    ...
    type: "monograph"
    tier: 1
    notes: "Definitive on the Egyptian priestly origins of the figure"
  ...
  - title: "Giordano Bruno and the Hermetic Tradition"
    ...
    type: "monograph"
    tier: 1
    notes: "Classic on Renaissance Hermeticism"
  - title: "Hermes Trismegistus (Stanford Encyclopedia of Philosophy)"
...
## Identity
Hermes Trismegistus ("thrice-greatest Hermes") is the syncretic Greco-Egyptian figure that emerged in Hellenistic Egypt from the equation of the **Egyptian god Thoth** — scribe of the gods, lord of writing and magic — with the **Greek god Hermes** — messenger of the gods, psychopomp, patron of writing. The epithet *trismegistos* ("thrice-greatest") translates an Egyptian temple-formula ("Thoth the very, very, very great") attested at Hermopolis (Khmun). The figure functions on two levels: (a) a *god* — the divine source of revealed wisdom; (b) a *legendary ancient sage-king* — to whom the Hermetic literature is pseudepigraphically attributed and whose human-divine status is left deliberately ambiguous. From the early Roman period through the Renaissance, Hermes Trismegistus was the alleged author of a vast revealed library: cosmological, alchemical, astrological, magical, philosophical, medical.

## Earliest attestation
- The equation Thoth = Hermes runs back to **Herodotus** (~-440, *Histories* 2.138, where "Hermopolis" is the Greek name for an Egyptian city).
- The full epithet *Trismegistos* and the literary persona crystallize in the Hellenistic period (Ptolemaic Egypt, ~-200/-50), in Egyptian temples writing in Greek.
- Earliest extant Hermetic literature: 1st–3rd century CE (the Corpus Hermeticum).
- The figure was treated by some early Christian writers (Lactantius, Augustine) as a pagan precursor to Christianity; this set up his Renaissance revival.
...
- Scribe's palette and reed pen
- Winged caduceus (Greek Hermes-attribute) sometimes combined with Egyptian solar disc
