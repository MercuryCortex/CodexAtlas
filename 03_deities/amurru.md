...
domains: ["the western steppe", "nomadic pastoralism", "mountains", "tent-dwelling life", "the boundary between settled and nomadic"]
gender: "masculine"
role: "tutelary god of the Amorite (Amurru) ethnic-political group; personification of West-Semitic nomadic pastoralism within the Mesopotamian pantheon; god of the western desert-steppe"
parent-of: []
child-of: ["[[an-sumerian]] / Anu (in Old Babylonian sources)"]
consort: ["[[belet-seri-akkadian]] (in some West-Semitic-flavored Old Babylonian sources, paired as steppe-god + steppe-goddess; the equation is uncertain)", "Ashratu (Sumerian rendering of West-Semitic Asherah, in a few sources)"]
attributes: ["shepherd's crook", "throw-stick (*gamlu* — the characteristic Amorite weapon)", "raw meat (instead of cooked food — emblematic of nomadic life seen from the Sumerian center)", "mountain"]
...
refs:
  - title: "Gods, Demons and Symbols of Ancient Mesopotamia: An Illustrated Dictionary"
    ...
    type: "reference"
    tier: 1
  - title: "Encyclopaedia of Religion and Ethics (Amorite religion)"
    author: "Hastings, James (ed.)"
    year: 1908-1926
    publisher: "T&T Clark"
    type: "encyclopedia"
    tier: 3
tags: [deity, akkadian, amorite, west-semitic, nomadic, steppe, martu, sentinel-stub]
---
