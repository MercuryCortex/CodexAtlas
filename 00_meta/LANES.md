...
- Does **any** path match a Lane A prefix (`^0[1-9]_`, `^1[0-9]_`, `^2[0-6]_`, `^00_meta/(STATUS|ACTIVE-CONTENT|DASHBOARD|dead-links|orphan-nodes|quality-issues|canonical-slugs|ONTOLOGY-RATIONALE-.*)\.md$`)?
