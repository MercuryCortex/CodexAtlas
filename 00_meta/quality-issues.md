...
| `henry-steel-olcott` | person | status:metadata but only 0 refs |
| `the-bab` | person | status:metadata but only 1 refs |
| `hans-jonas` | person | status:metadata but only 1 refs |
| `sri-yukteswar` | person | status:metadata but only 0 refs |
| `rudolf-steiner` | person | status:metadata but only 0 refs |
...
| `helena-blavatsky` | person | status:metadata but only 1 refs |
| `krishnadasa-kaviraja` | person | status:metadata but only 1 refs |
| `doreen-valiente` | person | status:metadata but only 0 refs |
...
| `g-i-gurdjieff` | person | status:metadata but only 0 refs |
...
| `marshall-vian-summers` | person | status:metadata but only 0 refs |
...
| `stephen-mcnallen` | person | status:metadata but only 0 refs |
| `p-d-ouspensky` | person | status:metadata but only 0 refs |
...
| `v-d-savarkar` | person | status:metadata but only 0 refs |
