...
| 8 | `tradition-hinduism` | `tattoo-sacred`, `sudarshana-chakra`, `sacred-number-three` … |
| 7 | `wikilink` | `methodology`, `AGENTS`, `STATUS` … |
| 6 | `wikilinks` | `app-usage`, `AGENTS`, `STATUS` … |
| 4 | `parallel-motif` | `spyridon-marinatos`, `hyperdiffusionism`, `theme-sacred-bloodline-claim` … |
| 3 | `tradition-sunni-islam` | `rub-el-hizb`, `basmala`, `event-muhammads-miraj-619` |
...
| 2 | `phase-3-006-homeric-hymns` | `adonis`, `sacred-marriage` |
