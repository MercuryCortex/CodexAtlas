...
> **DEPLOYED 2026-07-31** — `codexatlas.org` serves `?v=20260731-wave3b` (THE RING + the type scale + the three interaction laws), verified in real Safari against the live domain. Read this,
