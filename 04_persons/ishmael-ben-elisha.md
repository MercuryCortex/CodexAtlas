...
status: "stub"
refs:
  - title: "Mekhilta de-Rabbi Ishmael"
    author: "Lauterbach, Jacob Z."
    year: 1933
    publisher: "JPS (reprint 2004, JPS Classic Reissue)"
    type: "primary-translation"
    tier: 1
  - title: "Rabbi Ishmael and His Thirteen Hermeneutical Rules"
    author: "Yadin, Azzan"
    year: 2004
    publisher: "in *Scripture as Logos*, U. Penn Press"
    type: "monograph"
    tier: 1
  - title: "The Origins of the Kabbalah"
    author: "Scholem, Gershom"
    year: 1962
    publisher: "JPS / Princeton UP (Eng. 1987)"
    type: "monograph"
    tier: 1
    notes: "On the pseudonymous Hekhalot ascription"
tags: [person, judaism, tannaitic, ishmael-ben-elisha, akiva, mekhilta, hermeneutics, hekhalot-pseudonymity]
---
...
## Works
- **The *Mekhilta de-Rabbi Ishmael*** — exegetical midrash on Exodus from his school.
- **The thirteen *middot*** (hermeneutical rules) traditionally ascribed to him (in fact compiled in his school's tradition).

## Role in the tradition
- **Founding figure of the *peshat*-leaning ("plain-sense") school of Tannaitic exegesis**: contrasts with Akivan maximalism.
- **The thirteen middot**: still recited in Jewish daily liturgy.
- **Pseudonymous Hekhalot tradition**: large portions of the early Jewish mystical-mystical corpus (*Hekhalot Rabbati*, *Sefer Heikhalot*) are pseudonymously attributed to him and his school — making the historical R. Ishmael the named figure of Jewish mystical literature far beyond his historical reach.

## Disputes
- **Authenticity of the thirteen middot**: largely Tannaitic-school work, compiled after his death.
- **Martyrdom narrative**: legendary, late.
- **Hekhalot ascription**: pseudonymous; the historical R. Ishmael had no connection to the medieval mystical corpus that bears his name.
