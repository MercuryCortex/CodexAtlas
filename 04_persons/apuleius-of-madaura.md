...
mentioned-in: ["**[[augustine-of-hippo]]** — *De Civitate Dei* 8.14–22, 9.3–8 (extensive engagement with Apuleius's daimonology and his alleged magical practices; Augustine treats Apuleius as a principal Latin-language Platonist authority on demons)", "**Lactantius** — *Divinae Institutiones*", "**various Late-Antique grammarians and rhetoricians**"]
status: "metadata"
refs:
  - title: "Apuleius: A Latin Sophist"
    ...
    type: "monograph"
    tier: 1
    notes: "The standard modern critical biography and intellectual context"
  - title: "The Isis Book: A Commentary on Apuleius Metamorphoses XI"
    ...
    tier: 1
    notes: "The load-bearing commentary on the Isis-initiation in Met. Bk 11"
  - title: "The Golden Ass / Metamorphoses"
    author: "Apuleius (trans. Hanson, J.A.)"
    year: 1989
    publisher: "Harvard UP / Loeb Classical Library 44–45 (2 vols.)"
    type: "primary-translation"
    tier: 1
  - title: "Apuleius and Antonine Rome: Historical Essays"
    author: "Bradley, Keith"
    year: 2012
    publisher: "Toronto UP"
    type: "monograph"
    tier: 1
  - title: "Isis in the Ancient World"
    ...
    type: "monograph"
    tier: 1
tags: [person, latin-literature, middle-platonism, mystery-initiate, apuleius-madaurensis, isis-cult, golden-ass, metamorphoses, magic-trial-sabratha, north-africa, hermetic-asclepius-attributed]
---
...
2. **Latin Middle Platonism** — his Latin philosophical handbooks transmit Greek Middle-Platonist doctrines, especially daimonology, into the Latin philosophical tradition (and from there into Augustine's engagement in *De Civitate Dei*).
3. **Latin Hermetic *Asclepius*** — the traditional attribution to Apuleius (preserved in Augustine) makes Apuleius the named-author-figure of one of the foundational Latin Hermetic texts ([[phase-4-012-asclepius]]) — even though the actual attribution is now disputed.
...
- ***De Platone et eius dogmate*** — Latin Middle-Platonist philosophical handbook.
- ***De mundo*** — Latin pseudo-Aristotelian cosmological adaptation.

## Role in the tradition

- **First-person mystery-initiation witness.** Met. Bk 11.23 famously refuses to specify the central content of the initiation: *"Accessi confinium mortis et calcato Proserpinae limine per omnia vectus elementa remeavi; nocte media vidi solem candido coruscantem lumine; deos inferos et deos superos accessi coram et adoravi de proximo"* — "I approached the boundary of death and, having trodden the threshold of Proserpina, was carried through all the elements and returned; in the middle of the night I saw the sun shining with brilliant light; I approached the gods below and the gods above and worshipped them face to face." **The most-quoted single passage on ancient mystery-initiation content** — and explicitly designed by Apuleius to *not quite* reveal the content while strongly indicating its character.
- **Latin Middle-Platonist transmitter.** Apuleius's daimonology (in *De deo Socratis* and embedded in Met. and Apol.) becomes the principal Latin-philosophical vehicle for Greek Middle-Platonist daimonology, with substantial reception in Augustine.
- **Latin literary canon foundation.** With Petronius, the foundational Latin-novel author; massively influential on Boccaccio (*Decameron*), Cervantes, and the Western novel-tradition.
- **Possible Latin Hermetic *Asclepius* author.** The attribution is disputed (Hijmans 1987 et al. argue *against*; the traditional attribution remains live in some manuscripts).
...
- → [[plutarch]] *parallel-tradition*: contemporary Greek Middle-Platonist mystery-engagement; Plutarch's [[phase-4-072-plutarch-de-iside-et-osiride|*De Iside et Osiride*]] is the Greek philosophical-allegorical counterpart to Apuleius's first-person Latin literary witness.
- → [[augustine-of-hippo]] *direct-engagement*: Augustine *De Civitate Dei* 8.14–22 engages Apuleius extensively as Latin Platonist and as alleged magician.
- → [[mystery-initiation]] *theme-paradigmatic-witness*.
- → [[katabasis-and-anabasis]] *theme-paradigmatic-witness* (the *confinium mortis* / boundary-of-death + return).

## Disputes
- **Was Apuleius himself an Isis-initiate?** Likely but not certain. Met. Bk 11 is *fictional* in form (the protagonist is Lucius, not Apuleius), but the cultic detail is held to be authentic. Griffiths 1975 reads the cultic content as reliable; Harrison 2000 is more cautious.
- **Did Apuleius write the Latin *Asclepius*?** Disputed. The attribution is documented (Augustine references it) but modern stylistic analysis (Hijmans 1987) raises questions.
- **Was Apuleius an actual magician?** The *Apologia* defends against criminal charges of magic; he successfully defended himself. The historical truth is unrecoverable; Apuleius certainly engaged philosophical-theurgic discourse, but whether he practiced what 2nd-c. Roman law called *magia* is undeterminable.

## Refs
1. Harrison, S.J. (2000). *Apuleius: A Latin Sophist*. OUP.
2. Griffiths, J.G. (1975). *The Isis Book: A Commentary on Apuleius Metamorphoses XI*. Brill.
3. Bradley, K. (2012). *Apuleius and Antonine Rome*. Toronto UP.
