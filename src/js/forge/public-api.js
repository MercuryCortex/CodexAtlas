// ============================================================
// CODEX ATLAS — FORGE · PUBLIC-API (Phase 23.1 carve)
// ============================================================
// Lift-and-shift of `installPublicApi()`. PURE REFACTOR.
// Boundary: window._forgePublicApi.attach({ camera, local, rebuildForMode, saveRuntimeState })
// ============================================================
(function () {
  'use strict';
