// ============================================================
// CODEX ATLAS — FORGE · SIDE PANEL (Phase 23.1g carve)
// ============================================================
// Filed: 2026-05-25 by watcher-claude-lead.
// Lift-and-shift of `wireSidePanel()` — the LARGEST single carve
// in Phase 23 series at ~870 LOC. PURE REFACTOR.
//
// Owns the right-rail deity-details panel that opens on lock:
// cover image, tradition badge, era, sources tier surface,
// connection bucket breakdown, cross-tradition edge list.
//
// Boundary: window._forgeSidePanel.attach({ local, renderer, toggleLock, triggerClickPulse })
// ============================================================
(function () {
  'use strict';
