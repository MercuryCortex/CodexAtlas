...
(function () {
  ...
  const SIGNS = [
    ...
    { sign: '\u{12000}', code: 'A',      name: 'A',       meaning: 'water / canal',          category: 'Elements',
      ...
      relatedNodes: ['enki-ea', 'tiamat', 'phase-1-016-eridu-genesis-flood', 'tradition-sumerian-mesopotamian'] },
    { sign: '\u{12019}', code: 'AN',     name: 'AN',       meaning: 'sky / heaven / deity',   category: 'Sacred Realm',
      ...
      relatedNodes: ['an-sumerian', 'enlil', 'phase-1-008-enuma-elish', 'tradition-sumerian-mesopotamian'] },
    { sign: '\u{121B8}', code: 'UD',     name: 'UD',       meaning: 'sun / day / white',      category: 'Elements',
      ...
      relatedNodes: ['tradition-sumerian-mesopotamian', 'phase-1-011-great-hymn-to-aten'] },
    { sign: '\u{1207F}', code: 'KI',     name: 'KI',       meaning: 'earth / place',          category: 'Elements',
      ...
      relatedNodes: ['ki-sumerian', 'ninhursag-nintud', 'eridu', 'tradition-sumerian-mesopotamian'] },
    { sign: '\u{12309}', code: 'ID₂',   name: 'ID',       meaning: 'river',                  category: 'Elements',
      ...
      relatedNodes: ['enki-ea', 'tiamat', 'phase-1-016-eridu-genesis-flood'] },
    // Sacred Realm
    { sign: '\u{1202D}', code: 'DINGIR', name: 'DINGIR',   meaning: 'god / star',             category: 'Sacred Realm',
      ...
      relatedNodes: ['an-sumerian', 'enki-ea', 'enlil', 'phase-1-008-enuma-elish'] },
    { sign: '\u{12038}', code: 'EN',     name: 'EN',       meaning: 'lord / master',          category: 'Sacred Realm',
      ...
      relatedNodes: ['enki-ea', 'enlil', 'inanna-sumerian', 'phase-1-003-enheduanna-hymns'] },
    { sign: '\u{1212D}', code: 'ME',     name: 'ME',       meaning: 'divine powers / being',  category: 'Sacred Realm',
      ...
      relatedNodes: ['inanna-sumerian', 'enki-ea', 'phase-1-017-descent-of-inanna'] },
    { sign: '\u{12048}', code: 'ERIN₂', name: 'ERIN',     meaning: 'cedar / army',           category: 'Sacred Realm',
      ...
      relatedNodes: ['gilgamesh-king', 'phase-1-004-gilgamesh-old-babylonian', 'phase-1-013-baal-cycle'] },
    { sign: '\u{12208}', code: 'NAM',    name: 'NAM',      meaning: 'fate / destiny',         category: 'Sacred Realm',
      ...
      relatedNodes: ['phase-1-033-anzu-myth', 'phase-1-008-enuma-elish', 'tiamat'] },
    { sign: '\u{12246}', code: 'GEŠTU', name: 'GEŠTU',    meaning: 'ear / wisdom',           category: 'Sacred Realm',
      ...
      relatedNodes: ['enki-ea', 'phase-1-034-adapa-myth', 'tradition-sumerian-mesopotamian'] },
    { sign: '\u{1222C}', code: 'ZI',    name: 'ZI',       meaning: 'life / breath / soul',   category: 'Sacred Realm',
      ...
      relatedNodes: ['ninhursag-nintud', 'inanna-sumerian', 'phase-1-016-eridu-genesis-flood'] },
    // Society & Power
    { sign: '\u{12115}', code: 'LU',     name: 'LU',       meaning: 'person / man',           category: 'Society',
      ...
      relatedNodes: ['gilgamesh-king', 'phase-1-015-sumerian-king-list'] },
    { sign: '\u{12074}', code: 'LUGAL',  name: 'LUGAL',    meaning: 'king (great man)',       category: 'Society',
      ...
      relatedNodes: ['gilgamesh-king', 'phase-1-015-sumerian-king-list', 'marduk'] },
    { sign: '\u{1208D}', code: 'GAL',    name: 'GAL',      meaning: 'great / large',          category: 'Society',
      ...
      relatedNodes: ['enlil', 'marduk', 'tradition-sumerian-mesopotamian'] },
    // Nature & Production
    { sign: '\u{12163}', code: 'NINDA',  name: 'NINDA',    meaning: 'bread / food',           category: 'Production',
      ...
      relatedNodes: ['mathematics-babylonian-temple', 'tradition-sumerian-mesopotamian'] },
    ...
    { sign: '\u{12236}', code: 'GI',     name: 'GI',       meaning: 'reed',                   category: 'Production',
      ...
      relatedNodes: ['tradition-sumerian-mesopotamian', 'phase-1-001-kesh-temple-hymn'] },
    { sign: '\u{12229}', code: 'GUD',    name: 'GUD',      meaning: 'bull / ox',              category: 'Production',
      ...
      relatedNodes: ['an-sumerian', 'inanna-sumerian', 'phase-1-004-gilgamesh-old-babylonian'] },
    // Numbers
    { sign: '𒐕',        code: '1',     name: 'ONE',      meaning: '1 (vertical stroke)',    category: 'Numbers',
      ...
      relatedNodes: ['mathematics-babylonian-temple'] },
    { sign: '𒐙',        code: '10',    name: 'TEN',      meaning: '10 (corner stroke)',     category: 'Numbers',
      ...
      relatedNodes: ['mathematics-babylonian-temple', 'phase-1-019-enuma-anu-enlil'] },
    ...
    { sign: '𐎀', code: 'ALF',   name: 'Ugaritic Aleph', meaning: 'ox — alphabetic cuneiform', category: 'Script Bridge',
      ...
      relatedNodes: ['alphabet-ugaritic', 'alphabet-phoenician', 'event-ras-shamra-excavation-1928'] },
    { sign: '𐎁', code: 'BET',   name: 'Ugaritic Beth',  meaning: 'house — medium vs. message', category: 'Script Bridge',
      ...
      relatedNodes: ['alphabet-ugaritic', 'alphabet-phoenician', 'phase-1-013-baal-cycle'] },
    { sign: '𐎒', code: 'ŠN',    name: 'Ugaritic Shin',  meaning: 'tooth — the samekh question', category: 'Script Bridge',
      ...
      relatedNodes: ['alphabet-ugaritic', 'phase-1-013-baal-cycle', 'event-ras-shamra-excavation-1928'] },
    { sign: '𐎍', code: 'LAM',   name: 'Ugaritic Lamd',  meaning: 'ox goad — the bilingual archive', category: 'Script Bridge',
      ...
      relatedNodes: ['alphabet-ugaritic', 'phase-1-013-baal-cycle', 'phase-1-014-ugaritic-ritual-texts', 'event-ras-shamra-excavation-1928'] },
  ];
  ...
  function render(pane) {
    ...
    CATEGORIES.forEach(cat => {
      ...
      if (expanded) {
        ...
        const nodesHtml = (expanded.relatedNodes || []).length
          ? `<div class="age-inv-nodes" style="margin-top:0.5rem">${(expanded.relatedNodes).map(id =>
              `<span class="age-inv-node acv-node-chip" data-id="${id}">${id.replace(/^phase-\d+-\d+-/,'').replace(/^phase-\d+-/,'').replace(/-/g,' ')}</span>`
            ).join('')}</div>`
          : '';
        detail.innerHTML = `
        ...
        `;
        detail.querySelectorAll('.acv-node-chip[data-id]').forEach(chip => {
