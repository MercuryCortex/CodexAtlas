...
(function () {
  ...
  // 2026-05-26 — LOCK system removed. The zoom↔density linkage was
  // rarely used and confused the bottom-right control cluster. The
  // numeric readout now lives in the click-to-reset button at the
  // bottom of the slider (was a standalone div above the track).
  let mounted      = false;
  ...
  function buildBottomToolbar() {
    ...
    // 2026-05-26 — LOCK toggle removed. The readout-button at the
    // bottom of the slider (id="forge-tl-vdensity-readout") is now
    // a click-to-reset trigger. Wired inside wireVDensity().
  ...
  // Rarely-used control surface; the readout-button click-to-reset
  // gives the user direct override without needing a separate mode.
