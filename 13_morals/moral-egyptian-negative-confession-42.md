---
id: moral-egyptian-negative-confession-42
title: "The Egyptian Negative Confession — The Forty-Two Declarations of Innocence Before the Hall of Two Truths"
type: moral
...
geo: "Egypt / Theban necropolis"

cross-moral-edges:
  - target: moral-ten-commandments
    type: ancestor-of
    note: "The Negative Confession (c. 1550 BCE in its Book of the Dead form, with antecedents in Coffin Texts c. 2000 BCE) precedes the Decalogue by 350-1000 years and contains nine of the second-table prohibitions (no killing, no theft, no false witness, no adultery, no sexual misconduct) embedded in a ritual self-declaration framework — the earliest surviving moral checklist."
    source: "Assmann, Jan. *Ma'at: Gerechtigkeit und Unsterblichkeit im Alten Ägypten.* C. H. Beck, 1990."
    source-tier: T1
  - target: moral-buddhist-five-precepts
    type: parallel-form
    note: "Both traditions independently formulate a moral checklist whose violation has soteriological consequence — the Five Precepts for karmic-rebirth status, the 42 Declarations for postmortem judgment outcome."
    source-tier: T1
  - target: moral-golden-rule-cross-tradition
    type: parallel-form
    note: "Maat-aligned conduct presupposes reciprocity — the principle 'I have done what humans say and gods praise' frames moral identity through the imagined judgment of the social and divine other."
    source-tier: T1
...
refs:
  ...
  - "Faulkner, R. O. *The Ancient Egyptian Book of the Dead* (Carol Andrews ed.). British Museum, 1985 — (Tier-1)"
  - "Assmann, Jan. *Ma'at: Gerechtigkeit und Unsterblichkeit im Alten Ägypten.* C. H. Beck, 1990 — (Tier-1)"
  - "Hornung, Erik. *The Ancient Egyptian Books of the Afterlife.* Cornell University Press, 1999 — (Tier-1)"
  - "Quirke, Stephen. *Going Out in Daylight — prt m hrw: The Ancient Egyptian Book of the Dead.* Golden House, 2013 — (Tier-1)"
  - "Smith, Mark. *Following Osiris: Perspectives on the Osirian Afterlife from Four Millennia.* Oxford University Press, 2017 — (Tier-1)"
---

## The Egyptian Negative Confession — The Forty-Two Declarations of Innocence Before the Hall of Two Truths

The **Negative Confession** (also called *Declaration of Innocence*) is a forty-two-item moral self-declaration recited by the deceased before the tribunal of forty-two assessor-gods in the *Hall of Two Truths* (Maaty), preserved in **Spell 125 of the Book of the Dead** (the New Kingdom papyrus tradition, c. 1550 BCE, with Middle Kingdom Coffin Text antecedents going back to c. 2000 BCE). It is the earliest surviving structured ethical checklist in any human tradition — predating the Mosaic Decalogue by 350–1000 years depending on the dating one accepts for Exodus 20. The fullest published form is the Papyrus of Ani (c. 1250 BCE, British Museum EA 10470) translated authoritatively by T. G. Allen 1974 and Faulkner 1985.

### The Ritual Structure: Two Confessions Before the Forty-Two Assessors

Spell 125 has two declarations. The **first** is addressed to Osiris and lists thirty-six general moral and ritual offenses ("I have not committed sin… I have not robbed… I have not killed… I have not stolen the bread-rations of the gods…"). The **second** is addressed directly to each of the forty-two assessor-gods individually, naming each by his cult-place ("O Wide-of-Stride who comes forth from Heliopolis, I have not done evil" / "O Flame-Embracer who comes forth from Kheraha, I have not robbed…"). The total checklist is structurally similar to a divinely-imposed bill of rights for the Egyptian moral citizen, with each declaration paired to a witnessing daimonic judge whose name encodes a geographic-religious origin.

The forty-two number is not arbitrary — Egyptologists since Sethe have identified it as one judge per nome (administrative district), so that the deceased's moral standing is theoretically verified by representatives of every territorial cult in Egypt. The judgment scene is not abstract but federal: every region of Egypt is represented in the tribunal that confirms or rejects the soul's claim to moral integrity.

### The Content: A Forty-Two-Item Moral Ontology
