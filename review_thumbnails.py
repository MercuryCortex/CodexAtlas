...
NODE_DIRS = [
    ...
    ("09_symbols",   "symbol"),
    # ---- extension pass (2026-08-02): mirrors fetch_thumbnails.py NODE_DIRS ----
    ("08_places",    "place"),
    ("10_music",     "music"),
    ("11_alphabets", "alphabet"),
    ("12_alchemy",   "alchemy"),
    ("13_morals",    "moral"),
    ("14_rituals",   "ritual"),
    ("15_philosophy","philosophy"),
    ("16_mathematics","mathematics"),
    ("17_medicine",  "medicine"),
    ("18_languages", "language"),
    ("19_astronomy", "astronomy"),
    ("20_sacred_architecture", "sacred-architecture"),
    ("21_theology",  "theology"),
    ("22_practices", "practice"),
    ("23_material_culture", "material-culture"),
    ("24_pharmacology", "pharmacology"),
    ("25_divination","divination"),
    ("26_calendars", "calendar"),
    ("27_attire",    "attire"),
    ("28_exchange_networks", "exchange-network"),
    ("29_technology","technology"),
    ("31_consciousness", "consciousness"),
]
